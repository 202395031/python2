...
# 최대 인구 비교 할때 쓸 변수
max_population = city_info[0][1]    # 첫번째 항목이 기준이됨
...
max_city = city_info[0][0] # 첫번째 항목이 기준이됨

# 최소 인구수를 가진 지역(튜플)을 저장할 변수
min_city = city_info[0][0]

# city_info 만큼 반복 (city에는 지역명을 population 인구수를 저장)
for city, population in city_info:
    
    # population에 저장된 값을 total_population에 저장하는데 인구 수 만 저장함
    total_population += population
    
    # population이 인구수인데 그 인구수랑 max_population 즉 현 최대인구랑 비교 했을때
    if population > max_population:
        
        # population 이 최대 인구보다 크면 max_population에 population 값을 저장
        max_population = population
        
        # max_city에 city 값을 저장한다.
        max_city = city
    
    # population이 인구수인데 그 인구수랑 min_population 즉 현 최소인구랑 비교 했을때
    if population < min_population:
        
        # population 이 최소 인구보다 크면 min_population에 population 값을 저장
